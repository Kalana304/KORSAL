...
opts.basedetDir = sprintf('../../RealTime/%s/results/%s_%s_100dets/',model_type,dataset, imtypes{1});
opts.topdetDir = sprintf('../../RealTime/%s/results/%s_%s_100dets/',model_type,dataset, imtypes{2});
