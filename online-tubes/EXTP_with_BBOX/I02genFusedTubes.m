...
data_root = '../../data';
save_root = '../../finalresults/AAF-C-ExtraWBox';
...
%     };
completeList = {...
    {'ucf24','01',{'rgb','brox'},[120000,120000],{'cat'}, 0.25},...
    {'ucf24','01',{'rgb','fastOF'},[120000,120000],{'cat'}, 0.25},...
    };
% completeList = {...
%     {'hmdb21','01',{'rgb','brox'},[120000,120000],{'cat'}, 0.25},...
%     {'hmdb21','01',{'rgb','fastOF'},[120000,120000],{'cat'}, 0.25},...
%     };
...
alldopts = cell(2,1);
count = 0;
for setind = 2%:length(completeList)
...
%% save results
save_dir = [save_root,'/results/ARTF-UCF24'];
if ~isdir(save_dir)
    mkdir(save_dir)
end
